...
$s['q1'] = '功能更新和累積更新之間有什麼差別？';
$s['a1'] = <<<FAQ
功能更新包含了基礎及額外更新。<br/>
累積更新僅包含基礎更新。<br/><br/>

在產生 ISO 檔案時，建議使用功能更新。
FAQ;

$s['q2'] = '我要怎麼建立如企業版等 Windows 10 版本的 ISO？';
$s['a2'] = <<<FAQ
企業版是 Windows 10 的 <b>虛擬版本</b>。這裡的虛擬不是指「虛擬化」，而是「非獨立版本」。<br/><br/>

虛擬版本需要「基礎版本」方可轉換。<br/>
選擇好更新的版本後，頁面右方將顯示不同虛擬版本的所需條件。<br/>
例如「Windows 10 企業版」的所需條件為「Windows 10 專業版」，所以您必須先行選擇。<br/><br/>

選擇好專業版後，點擊「下一步」並選擇「轉換並建立額外版本」選項。<br/>
將出現所有可用的虛擬版本列表；<br/><br/>

您即可選擇「企業版」並建立下載套件。
FAQ;

$s['q3'] = '為什麼有些 Windows Server 下載會顯示「這個組建沒有可用的語言」?';
$s['a3'] = <<<FAQ
舊版的 Windows Server 更新僅包含 Feature on Demand 套件。<br/>
故無法用於轉換。 
FAQ;

$s['q4'] = '我可以在轉換前移除我認為沒用的套件嗎？';
$s['a4'] = <<<FAQ
不能。移除套件將導致轉換失敗。
FAQ;

$s['q5'] = '為什麼有兩個名稱相同的組建，但其中一個被標記 (2)？';
$s['a5'] = <<<FAQ
通常這表示該組建被推送到多個通道。<br/>
例如某個組建先被推送到 Dev 版通道，然後再被通送到 Beta 版通道。<br/><br/>

組建的內容完全相同，不管選擇哪一個都行。
FAQ;

$s['qUnknown'] = '我的問題沒有被列在這裡。';
$s['aUnknown'] =  <<<FAQ
您可以加入 UUP dump 的 Discord 伺服器並發問。
只有以英文撰寫的問題會被回答。
FAQ;
